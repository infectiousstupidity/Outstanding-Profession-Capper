...
assert(state.learnedSpells[7413] == nil, "prerequisite spell state stays lazy until needed")
assert(state.isSpellKnown(7413) == true, "prerequisite spell resolves lazily")
assert(state.learnedSpells[7413] == true, "lazy prerequisite result is cached")
