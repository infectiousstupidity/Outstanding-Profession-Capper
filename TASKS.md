...
| [43 Smartest objective and availability filter](docs/tasks/43-smartest-objective-and-availability-filter.md) | QUEUED | Add lexicographic Smartest routing and make Available-now an orthogonal constraint. |
